...
salmon_transcript_tpm <- read.csv("../../results/salmon/salmon_merged_transcript_tpm.csv")

tx2gene <- read_csv(file.path("../../results/salmon", "tx2gene.csv"), col_names = FALSE)
colnames(tx2gene) <- c("transcript_id", "gene_id", "gene_name")
myh7b_trancripts <- tx2gene[which(tx2gene$gene_name == "MYH7B"),]

myh7b_quant <- salmon_transcript_tpm[salmon_transcript_tpm$transcript_id %in% myh7b_trancripts$transcript_id, ] 

myh7b_long <- myh7b_quant %>% gather(run_accession, tpm, 2:63) %>%
  merge(samples)
