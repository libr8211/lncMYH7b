...
samples <- read.csv("../sample_info/lncMYH7b_KD_NG_samplesheet.csv") %>%
...
```{r plot_ma}
plotMA(res_list_shrunken[[1]], lfcThreshold = params$lfc_threshold, ntop = 10, gene2symbol = g2s, alpha = 0.01)
```
...
```{r plot_volcano}
plotVolcano(res_list_shrunken[[1]], lfcThreshold = params$lfc_threshold, ntop = 10, gene2symbol = g2s, alpha = 0.01)
```
