...
write_csv(resdf_spoe, "../../ipscm_rnaseq/results/res_unshrunken_spoe.csv")
write_csv(resdf_asokd, "../../ipscm_rnaseq/results/res_unshrunken_asokd.csv")
```
...
>>>>>>> 2b262a9ef3a4058882a2b47d2fa837a4e638c8ab
```
